...
export default function WorkWithUsPage() {
  return (
    <main className="min-h-screen">
              ...
              return (
                ...
                >
                  <NextLink href={service.href}>
                    <div className="group relative bg-white rounded-3xl p-8 h-full border border-gray-200 hover:border-[#00AEEF]/30 hover:shadow-2xl transition-all duration-500 overflow-hidden">
                        ...
                        <ul className="space-y-2 mb-6">
                          {service.features.map((feature, idx) => (
                            <li key={idx} className="flex items-center text-sm text-gray-600">
                              <ChevronRight className="w-4 h-4 text-[#00AEEF] mr-2 flex-shrink-0" />
                              {feature}
                            </li>
                          ))}
                        </ul>

                        <div className="flex items-center text-[#00AEEF] font-bold group-hover:gap-2 transition-all duration-300">
                          Learn More
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#13182e] tracking-tight">
              ...
              <ul className="space-y-4">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-[#00AEEF]/10 flex items-center justify-center mr-4 mt-0.5 flex-shrink-0">
            ...
            >
              <div className="glass-dark rounded-3xl p-12 text-white">
                <div className="absolute inset-0 bg-gradient-to-br from-[#00AEEF]/20 to-transparent rounded-3xl" />
                <div className="relative z-10">
                  ...
                  <Button
                    as={NextLink}
                    href="#contact"
                    className="bg-white text-[#13182e] hover:bg-[#00AEEF] hover:text-white font-bold rounded-full transition-all duration-500 px-8 h-12"
      ...
      {/* CTA Section */}
      <section id="contact" className="py-24 bg-[#13182e] text-white relative overflow-hidden">
